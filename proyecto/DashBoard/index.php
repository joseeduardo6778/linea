<?php
   $conexion=mysqli_connect('localhost','id19804100_jose','vY%?tl|R+^7@4**X','id19804100_registro');
?>
...
<html lang="en">
    <head>
        ...
        <title>Inicio de la Plataforma - Admi</title>
            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="dropdown-item" href="CerrarSession.php">Cerrar sesion</a>
                    </li>
                    </ul>
                </li>
            </ul>
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; Sitio web 2021</div>
                            <div>
